...
\header{Brandon}{LeBeau, PhD}{Data and Statistics Maven} % Your name and current job title/field
...
{Educational Psychology -- Quantitative Methods in Education \\ \emph{Misspecification of the covariance matrix in the linear mixed model: A monte carlo simulation}} %\\ This thesis explored the idea that money has been the cause of untold anguish and suffering in the world. I found that it has, in fact, not.}
%------------------------------------------------
\entry
{2003--2007}
{Bachelor {\normalfont of Arts}}
...
\begin{refsection} % Print all articles not in press from the bibliography
\nocite{*}
...
%\begin{refsection} % Print all articles in press from the bibliography
%\nocite{*}
%\printbibliography[sorting=chronological, type=article, title={Articles In Press}, keyword={In Press}, heading=subbibliography]
%\end{refsection} 

%\newpage 
\begin{refsection} % Print all articles in preparation from the bibliography
\nocite{*}
\printbibliography[sorting=chronological, type=article, title={Articles In Preparation}, keyword={In Prep}, heading=subbibliography]
\end{refsection} 

%\newpage 
\printbibsection{unpublished}{Unpublished} % Print all books from the bibliography
...
\printbibsection{misc}{Presentations} % Print all miscellaneous entries from the bibliography
